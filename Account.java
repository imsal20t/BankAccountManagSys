...
public abstract class Account implements Comparable {
	 ...
	 * @param obj is an object of type account. 
    ...
    public int compareTo(Account obj) {
        if (accountNo == obj.accountNo && balance == obj.balance && fullName.equals(obj.fullName) &&
            dateOpened.equals(obj.dateOpened) && maxTransferable == obj.maxTransferable) {
            return 0;
        }

        return Integer.compare(accountNo, obj.accountNo);
    }
}
